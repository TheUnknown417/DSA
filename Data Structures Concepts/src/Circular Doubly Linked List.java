...
public class Main {
    public static void main(String[] args) {
        ...
        circularList.traverseForward(); // Output: 5 10 15 20 30
        circularList.traverseBackward(); // Output: 30 20 15 10 5

        // Delete karna aur list ko dobara check karna
        circularList.removeFromStart();
        circularList.traverseForward(); // Output: 10 15 20 30

        circularList.removeFromEnd();
        circularList.traverseForward(); // Output: 10 15 20

        circularList.removeFromPosition(2);
        circularList.traverseForward(); // Output: 10 20
    }
}
